...
public class Square {
	...
	/**
	 * Returns a character representing the square according to its state and content.
	 */
	...
	public void setValue(int value) {
		ArgumentChecks.isTrue(value>=-1, "Error: Value cannot be lower than -1");
		ArgumentChecks.isTrue(value<=8, "Error: Value cannot be higher than 8");
		content = value;
	}
